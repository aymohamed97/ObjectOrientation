...
/*
  ...
  values from the object carDetails into new variables. 
*/
...
//     Arizona:7279000,
//   }
//   const {Utah, California, Arizona, Texas}= obj
...
let wizard1 = new Wizard('Coco', 22, 'someCrazySpell')
...
//Code Here
let phone1 = new Phone('iphone', 'x', 128, 'pink', 700)
let phone2 = new Phone('samsung', 'note', 128, 'grey', 900)
let phone3 = new Phone('iphone', 'xr', 128, 'red', 0)
...
phone2.sell(this.soldProperties)
console.log(phone2)
...
//Code Here
let myFirstVehicle = new Vehicle(5, 'black', 80,000)
/* 
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(3, 'pink', 50000, 'Harley', true)
/*
